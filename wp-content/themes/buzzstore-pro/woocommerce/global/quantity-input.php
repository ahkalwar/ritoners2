...
if ( $max_value && $min_value === $max_value ) {
	...
	$label = ! empty( $args['product_name'] ) ? sprintf( __( '%s quantity', 'buzzstore-pro' ), wp_strip_all_tags( $args['product_name'] ) ) : __( 'Quantity', 'buzzstore-pro' );
	?>
	<div class="quantity">
		...
		<input
			...
			title="<?php echo esc_attr_x( 'Qty', 'Product quantity input tooltip', 'buzzstore-pro' ); ?>"
			size="4"
