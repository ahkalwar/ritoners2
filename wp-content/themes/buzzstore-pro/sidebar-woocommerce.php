...
if( is_singular() ){
	$post_sidebar =  esc_attr( get_theme_mod( 'buzzstorepro_woocommerce_product_page_layout','rightsidebar' ) );
}else{
	$post_sidebar =  esc_attr( get_theme_mod( 'buzzstorepro_woocommerce_category_page_layout','rightsidebar' ) );
}
